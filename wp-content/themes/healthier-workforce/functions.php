...
function hw_ninja_email_template( $message, $footer_text = 'The submission has been logged in the Associates spreadsheet.' ) {
    return '
<table border="0" cellpadding="0" cellspacing="0" width="100%">
  <tbody>
    ...
    <tr><td bgcolor="#ffffff" style="padding:30px;font-size:15px;line-height:24px;font-family:Arial,sans-serif;color:#333;">' . $message . '</td></tr>
...
add_filter( 'ninja_forms_action_email_message', function( $message, $action_settings ) {
    ...
    if ( in_array( $form_id, $form_ids ) ) {
        return hw_ninja_email_template( $message );
    }
