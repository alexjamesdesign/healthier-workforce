...
jQuery(function ($) {
    jQuery.fn.preventDoubleSubmission=function(){return $(this).on("submit",function(t){var e=$(this);e.data("submitted")===!0?t.preventDefault():e.data("submitted",!0)}),this};
});
...
jQuery(function ($) {
    $(document).ready(function() {
        ...
        $('.callback-form').adtrakValidate();
        $('.contact-form').adtrakValidate();
        $('form').preventDoubleSubmission();

        //alert(object_name.templateUrl);
        ...
        //begin ajax contact-form
         $(function() {
            $("form input[type=submit]").click(function(event) {
                ...
                //console.log('Form name = ', nice_form_name);
                
                var m_data = new FormData();
                m_data.append('form_name', nice_form_name);

                //array of fields to exclude from the Email
                var excludedInputNames = ['submit_contact_form', 'submit_callback_form', 'subscription'];
                ...
                var selectedFormCheckbox = $(selectedForm).find('input[type=checkbox]');
                    ...
                    success: function(response){
                     //load json data from server and output message
                        if(response.type == 'error'){ //load json data from server and output message
                            ...
                            output = $('.'+form_name+' input[type=submit]').attr('disabled', true);
                            output = $('.'+form_name+' input[type=submit]').attr('value', 'Sent!');
