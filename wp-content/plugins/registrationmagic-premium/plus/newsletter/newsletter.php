...
final class RM_EX_NLetter {
	...
	private function set_actions() { 
        ...
        {   
            ...
            if(isset($rm_form->form_options->enable_newsletter[0]) && $rm_form->form_options->enable_newsletter[0]==1)
            {   
        ...
        {    
            ...
            if ((isset($rm_form->form_options->form_is_opt_in_checkbox_nl[0]) && $rm_form->form_options->form_is_opt_in_checkbox_nl[0] == 1) && (isset($rm_form->form_options->enable_newsletter[0]) && $rm_form->form_options->enable_newsletter[0] == 1) && $editing_sub == false)
            {  
                if(!empty($form))
                {
