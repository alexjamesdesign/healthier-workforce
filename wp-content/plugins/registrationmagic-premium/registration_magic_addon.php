...
function deactivate_rm_addons_below_5231() {
    ...
    if(!empty($installed_premiums)) {
        foreach($installed_premiums as $installed_premium) {
            if(is_plugin_active($installed_premium['dir']) && version_compare($installed_premium['version'],'5.2.3.1','<')) {
...
deactivate_rm_addons_below_5231();
...
if (!defined('RM_ADDON_PLUGIN_VERSION')) {
    ...
    define('RM_ADDON_PLUGIN_VERSION', '5.2.3.1');
