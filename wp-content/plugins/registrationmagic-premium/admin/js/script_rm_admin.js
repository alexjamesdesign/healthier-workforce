...
jQuery(document).ready(function ($) {
    ...
    $('.rm-form-nav-menu a').on('click', function (event) {
        event.preventDefault();
        const targetPageId = $(this).attr('data-page');
        $('.rm-form-nav-menu a').removeClass('rm-form-nav-active');
        $(this).addClass('rm-form-nav-active');
        ...
        //$('#' + targetPageId).animate({ scrollTop: $(".rm-page-wrapper").offset().top - 100 }, "slow");
        
        const targetScrollPosition = $('#' + targetPageId).offset().top - 200;
       $('.rm-page-wrapper').animate({ scrollTop: targetScrollPosition }, 'slow');
       

        //$('#' + targetPageId).animate({scrollTop: 0}, 'slow');
        //$('.rm-form-page').removeClass('mundro');
        //$('#' + targetPageId).addClass('mundro');
        // Scroll to the top of the page
        //$('.rm-page-wrapper').animate({scrollTop: 0}, 'slow');
    });

    //Add active class on menu by default 
    $('.rm-form-nav-menu a:first-child').addClass('rm-form-nav-active');
...
//Inbox Quick view Modal 
    ...
    // Fetch submission data from a source (e.g., API)
    function fetchSubmissionData(submissionId) {
        // Implement your data fetching logic here
        // You can use AJAX or any other method to fetch data
    ...
    function populateModal(data) {
        $(".submission-data").html(data); // Update the modal content with the fetched data
    }
