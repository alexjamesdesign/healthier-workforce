        ...
        <ul>
            ...
            <li onclick="window.history.back()"><a href="javascript:void(0)"><?php echo RM_UI_Strings::get("LABEL_BACK"); ?></a></li>
               <li><a href="?page=rm_invitations_manage&rm_queues=true"><?php _e('Active Queues','registrationmagic-addon');  ?></a></li>
                <li><a href="?page=rm_sent_emails_manage"><?php _e('Outbox', 'registrationmagic-addon'); ?></a></li>
                <li><a href="https://registrationmagic.com/send-emails-registered-users-wordpress-single-click/" target="_blank"><?php _e('Documentation','registrationmagic-addon'); ?></a></li>
