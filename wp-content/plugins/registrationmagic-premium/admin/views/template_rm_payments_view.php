...
$form_type_status = $data->form_type_status;
    ...
    ?>
    <input type="hidden" name="form_id" id="hd_form_id" value="<?php echo wp_kses_post($data->form_id);?>">
    <input type="hidden" name="form_id" id="hd_submission_id" value="<?php echo wp_kses_post($data->submission->submission_id);?>">
    <input type="hidden" name="form_id" id="hd_payment_id" value="<?php echo wp_kses_post($data->payment->id);?>">
    <input type="hidden" name="form_id" id="hd_emaid_id" value="<?php echo wp_kses_post($data->submission->user_email);?>">
...
<script>
    ...
    function rm_update_payment_details_psm(pproc_id,success_msg, error_msg) {
        ...
        jQuery.post(ajaxurl, data, function(resp){
            ...
            if(resp == 'success'){
                if(status === 'success'){
                    var email_id = jQuery('#hd_emaid_id').val();
                    var form_id = jQuery('#hd_form_id').val();
                    var sub_id = jQuery('#hd_submission_id').val();
                    var pay_id = jQuery('#hd_payment_id').val();
                    rm_send_payment_confirmation_email(email_id,form_id,sub_id,pay_id,true);
                }
                alert(success_msg);
                jQuery('.rm-modal-view').hide();
    ...
    function rm_send_payment_confirmation_email(email_id, form_id, submission_id, payment_id,indirect=false) {
