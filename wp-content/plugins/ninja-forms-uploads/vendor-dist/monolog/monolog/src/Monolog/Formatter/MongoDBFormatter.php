...
class MongoDBFormatter implements \NF_FU_VENDOR\Monolog\Formatter\FormatterInterface
{
    ...
    {
        $formattedException = array('class' => \NF_FU_VENDOR\Monolog\Utils::getClass($exception), 'message' => $exception->getMessage(), 'code' => $exception->getCode(), 'file' => $exception->getFile() . ':' . $exception->getLine());
