...
class NormalizerFormatter implements \NF_FU_VENDOR\Monolog\Formatter\FormatterInterface
{
    ...
    protected function normalize($data, $depth = 0)
    {
        ...
        if (\is_object($data)) {
            ...
            return \sprintf("[object] (%s: %s)", \NF_FU_VENDOR\Monolog\Utils::getClass($data), $value);
        }
        if (\is_resource($data)) {
    ...
    protected function normalizeException($e)
    {
        ...
        $data = array('class' => \NF_FU_VENDOR\Monolog\Utils::getClass($e), 'message' => $e->getMessage(), 'code' => $e->getCode(), 'file' => $e->getFile() . ':' . $e->getLine());
                ...
                if (isset($frame['args'])) {
                    ...
                    $frame['args'] = \array_map(function ($arg) {
                        if (\is_object($arg) && !($arg instanceof \DateTime || $arg instanceof \DateTimeInterface)) {
                            return \sprintf("[object] (%s)", \NF_FU_VENDOR\Monolog\Utils::getClass($arg));
                        }
                        return $arg;
                    }, $frame['args']);
                }
