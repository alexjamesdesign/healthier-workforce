...
use NF_FU_VENDOR\GuzzleHttp\Cookie\CookieJarInterface;
...
final class Middleware
{
    ...
    public static function httpErrors()
    {
        return function (callable $handler) {
            return function ($request, array $options) use($handler) {
                ...
                return $handler($request, $options)->then(function (\NF_FU_VENDOR\Psr\Http\Message\ResponseInterface $response) use($request, $handler) {
     ...
     * @return callable Returns a function that accepts the next handler.
     */
    public static function log(\NF_FU_VENDOR\Psr\Log\LoggerInterface $logger, \NF_FU_VENDOR\GuzzleHttp\MessageFormatter $formatter, $logLevel = \NF_FU_VENDOR\Psr\Log\LogLevel::INFO)
    {
