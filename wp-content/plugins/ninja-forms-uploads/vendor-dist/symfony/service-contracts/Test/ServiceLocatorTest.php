 ...
 */
namespace NF_FU_VENDOR\Symfony\Contracts\Service\Test;

use NF_FU_VENDOR\PHPUnit\Framework\TestCase;
use NF_FU_VENDOR\Psr\Container\ContainerInterface;
use NF_FU_VENDOR\Symfony\Contracts\Service\ServiceLocatorTrait;
class ServiceLocatorTest extends \NF_FU_VENDOR\PHPUnit\Framework\TestCase
{
    public function getServiceLocator(array $factories)
    {
        return new class($factories) implements \NF_FU_VENDOR\Psr\Container\ContainerInterface
        {
