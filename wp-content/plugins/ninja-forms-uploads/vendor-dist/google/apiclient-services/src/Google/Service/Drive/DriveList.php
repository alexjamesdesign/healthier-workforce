 ...
 * the License.
 */
class Google_Service_Drive_DriveList extends \NF_FU_VENDOR\Google_Collection
{
 ...
 * the License.
 */
\class_alias('NF_FU_VENDOR\\Google_Service_Drive_DriveList', 'Google_Service_Drive_DriveList', \false);
