 ...
 * the License.
 */
class Google_Service_Drive_DriveFileImageMediaMetadata extends \NF_FU_VENDOR\Google_Model
{
    public $aperture;
    public $cameraMake;
    public $cameraModel;
     ...
     */
    public function setLocation(\NF_FU_VENDOR\Google_Service_Drive_DriveFileImageMediaMetadataLocation $location)
    {
 ...
 * the License.
 */
\class_alias('NF_FU_VENDOR\\Google_Service_Drive_DriveFileImageMediaMetadata', 'Google_Service_Drive_DriveFileImageMediaMetadata', \false);
