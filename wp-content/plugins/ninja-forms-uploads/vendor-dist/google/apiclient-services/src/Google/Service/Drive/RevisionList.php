 ...
 * the License.
 */
class Google_Service_Drive_RevisionList extends \NF_FU_VENDOR\Google_Collection
{
 ...
 * the License.
 */
\class_alias('NF_FU_VENDOR\\Google_Service_Drive_RevisionList', 'Google_Service_Drive_RevisionList', \false);
