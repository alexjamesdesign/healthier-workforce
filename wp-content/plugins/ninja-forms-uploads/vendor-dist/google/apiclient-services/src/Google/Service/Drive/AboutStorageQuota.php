 ...
 * the License.
 */
class Google_Service_Drive_AboutStorageQuota extends \NF_FU_VENDOR\Google_Model
{
    public $limit;
    public $usage;
    public $usageInDrive;
 ...
 * the License.
 */
\class_alias('NF_FU_VENDOR\\Google_Service_Drive_AboutStorageQuota', 'Google_Service_Drive_AboutStorageQuota', \false);
