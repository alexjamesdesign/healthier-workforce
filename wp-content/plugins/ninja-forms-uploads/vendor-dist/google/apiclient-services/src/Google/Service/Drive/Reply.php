 ...
 * the License.
 */
class Google_Service_Drive_Reply extends \NF_FU_VENDOR\Google_Model
{
    public $action;
 ...
 * the License.
 */
\class_alias('NF_FU_VENDOR\\Google_Service_Drive_Reply', 'Google_Service_Drive_Reply', \false);
