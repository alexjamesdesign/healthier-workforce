 ...
 * the License.
 */
class Google_Service_Drive_DriveCapabilities extends \NF_FU_VENDOR\Google_Model
{
 ...
 * the License.
 */
\class_alias('NF_FU_VENDOR\\Google_Service_Drive_DriveCapabilities', 'Google_Service_Drive_DriveCapabilities', \false);
