 ...
 * the License.
 */
class Google_Service_Drive_TeamDriveList extends \NF_FU_VENDOR\Google_Collection
{
 ...
 * the License.
 */
\class_alias('NF_FU_VENDOR\\Google_Service_Drive_TeamDriveList', 'Google_Service_Drive_TeamDriveList', \false);
