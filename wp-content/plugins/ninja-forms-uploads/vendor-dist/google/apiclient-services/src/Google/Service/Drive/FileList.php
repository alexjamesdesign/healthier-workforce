 ...
 * the License.
 */
class Google_Service_Drive_FileList extends \NF_FU_VENDOR\Google_Collection
{
 ...
 * the License.
 */
\class_alias('NF_FU_VENDOR\\Google_Service_Drive_FileList', 'Google_Service_Drive_FileList', \false);
