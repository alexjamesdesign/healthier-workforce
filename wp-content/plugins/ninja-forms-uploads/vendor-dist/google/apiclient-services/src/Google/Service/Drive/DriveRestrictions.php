 ...
 * the License.
 */
class Google_Service_Drive_DriveRestrictions extends \NF_FU_VENDOR\Google_Model
{
 ...
 * the License.
 */
\class_alias('NF_FU_VENDOR\\Google_Service_Drive_DriveRestrictions', 'Google_Service_Drive_DriveRestrictions', \false);
