 ...
 * the License.
 */
class Google_Service_Drive_Permission extends \NF_FU_VENDOR\Google_Collection
{
 ...
 * the License.
 */
\class_alias('NF_FU_VENDOR\\Google_Service_Drive_Permission', 'Google_Service_Drive_Permission', \false);
