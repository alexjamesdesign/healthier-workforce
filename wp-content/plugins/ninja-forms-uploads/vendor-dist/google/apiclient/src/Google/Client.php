 ...
 */
use NF_FU_VENDOR\Google\Auth\ApplicationDefaultCredentials;
...
use NF_FU_VENDOR\Google\Auth\Credentials\ServiceAccountCredentials;
use NF_FU_VENDOR\Google\Auth\Credentials\UserRefreshCredentials;
use NF_FU_VENDOR\GuzzleHttp\Client;
use NF_FU_VENDOR\GuzzleHttp\ClientInterface;
use NF_FU_VENDOR\GuzzleHttp\Ring\Client\StreamHandler;
...
use NF_FU_VENDOR\Monolog\Handler\StreamHandler as MonologStreamHandler;
use NF_FU_VENDOR\Monolog\Handler\SyslogHandler as MonologSyslogHandler;
/**
 ...
 * https://github.com/google/google-api-php-client
 */
\class_alias('NF_FU_VENDOR\\Google_Client', 'Google_Client', \false);
