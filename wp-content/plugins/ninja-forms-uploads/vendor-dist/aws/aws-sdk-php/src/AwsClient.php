...
use NF_FU_VENDOR\Aws\ClientSideMonitoring\ConfigurationProvider;
...
class AwsClient implements \NF_FU_VENDOR\Aws\AwsClientInterface
{
    ...
    private function parseClass()
    {
        ...
        if ($klass === __CLASS__) {
            return ['', 'NF_FU_VENDOR\\Aws\\Exception\\AwsException'];
        }
    ...
    private function loadAliases($file = null)
    {
        if (!isset($this->aliases)) {
            ...
            $aliases = \NF_FU_VENDOR\Aws\load_compiled_json($file);
    ...
    {
        $aliases = \NF_FU_VENDOR\Aws\load_compiled_json(__DIR__ . '/data/aliases.json');
