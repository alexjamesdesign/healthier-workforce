...
class rm_paypal_class {
	...
	public function submit_paypal_post() {
		...
		ob_start();
		echo "<html>\n";
		echo "<head><title>".__('Processing Payment','registrationmagic-gold')."</title></head>\n";
		echo "<body>\n";
		echo "<center><h2>".__('Please wait, your order is being processed and you will be redirected to the PayPal website.','registrationmagic-gold');
		echo "</h2></center>\n";
		...
		echo "<center><br/><br/>".__('If you are not automatically redirected to PayPal within 5 seconds...','registrationmagic-gold');
		echo "<br/><br/>\n";
		echo "<input type=\"submit\" value='".__('Click Here','registrationmagic-gold')."'></center>\n";
