        ...
        <div id="address" class="rm_address_type_<?php echo $this->_attributes['address_type']; ?>">
            ...
            <div class="rm_ad_container">
                    <?php if ($this->_attributes['country_en']) : ?>
                        <?php if($this->_attributes['state_type']=='all'): ?>
                            <div  class="wideField rm-alone rm-address-hw" colspan="3">
                                <select data-country-field="1" <?php echo $style; ?> id="<?php echo $name; ?>_country" <?php echo $this->_attributes['country_req'] ?>
                        ...
                        <?php if($this->_attributes['state_type']=='america_can'):  ?>
                            <div class="wideField rm-alone rm-address-hw" colspan="3">
                                <select data-country-field="1" <?php echo $style; ?> onchange="rm_load_states(this.value,'<?php echo $name; ?>_administrative_area_level_1','<?php echo $this->_attributes["state_as_code"] ?>'); rm_validate_zipcode('<?php echo $name; ?>')" class="field" id="<?php echo $name; ?>_country" 
                                         name="<?php echo $name; ?>[country]">
