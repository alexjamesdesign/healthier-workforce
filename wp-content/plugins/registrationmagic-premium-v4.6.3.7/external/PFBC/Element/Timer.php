...
class Element_Timer extends Element implements Widget
{
    ...
    public function jQueryDocumentReady() {
      echo "jQuery('#".spl_object_hash($this)."').FlipClock({clockFace: 'MinuteCounter'});";
    }
    
    public function render()
    { 
        ?>
        <div id="<?php echo spl_object_hash($this);  ?>" class="rm_clock <?php echo $this->_attributes["class"] ? ''.$this->_attributes["class"]:null; ?>" style="margin:2em;"></div>
        <?php
    }
