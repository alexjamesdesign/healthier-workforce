...
class Element_Repeatable extends Element
{
    ...
    public function render()
    {
        ...
        $this->_attributes["value"] = isset($this->_attributes["value"]) ? maybe_unserialize($this->_attributes["value"]) : array();
        if (!is_array($this->_attributes["value"])) {
            $this->_attributes["value"] = explode(',',$this->_attributes["value"]);
        }
        $counter = !empty($this->_attributes["value"]) ? count($this->_attributes["value"]) : 1;
