...
class Registration_Magic
{
    ...
    public function define_global_hooks()
    {
        ...
        //using clear_auth_cookie to retain user in session as wp_logout does not retain user after wordpress version 5.2
        $this->loader->add_filter('clear_auth_cookie', $this, 'get_user_before_logout',5);
    ...
    {
        if(!isset($_SESSION['RM_LOGOUT_USER']))
            return;
        
        $user = $_SESSION['RM_LOGOUT_USER'];
        unset($_SESSION['RM_LOGOUT_USER']);
