        ...
        <div id="rm_olp_admin_status_handler">
            ...
            <div id="rm_olp_edit_payment_status_popup" style="display:none">
                ...
                <div class="rm_olp_edit_payment_row">
                    ...
                    <div class="rm_sub_edit_input">
                        <textarea id="rm_olp_payment_note" placeholder="<?php echo $status == 'Pending' ? __( 'Enter payment details here. This note will show up in transaction details.', 'registrationmagic-gold' ) : __( 'Enter details such as Cheque number etc. These notes will show up in transaction details.', 'registrationmagic-gold' ); ?>"></textarea>
                    </div>
                </div>
                <div class="rm_olp_edit_payment_row">
                    <label>&nbsp;</label>
