...
class RM_Chronos {    
    ...
    public static function add_cron_interval($schedules) {
        $schedules['rm_automation_interval'] = array(
            ...
            'display'  => __("RM Automation Interval",'registrationmagic-gold'),
        );
    ...
    public static function add_admin_pages()
    {
        ...
        if((time() - (int)$rm_automation_intro_time) <= $thirty_days )
            $menu_title .= "&nbsp;<span class='update-plugins'><span class='update-count'>".__('New','registrationmagic-gold')."</span></span>";
        add_submenu_page("rm_form_manage",__('Automation','registrationmagic-gold'), $menu_title, "manage_options", "rm_ex_chronos_manage_tasks",  "RM_Chronos::handle_request" );
        add_submenu_page("","RM Chronos 3", __('RM Chronos 3','registrationmagic-gold'), "manage_options", "rm_ex_chronos_edit_task",  "RM_Chronos::handle_request" );
    }
