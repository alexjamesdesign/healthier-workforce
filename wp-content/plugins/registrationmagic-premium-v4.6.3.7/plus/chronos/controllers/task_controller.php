...
class RM_Chronos_Task_Controller
{
    ...
    public function manage_tasks($req)
    {
        ...
        $chronos_js_vars= array(
                            'empty_error'=>__('Value can not be empty','registrationmagic-gold'),
                            'removing'=>__('Removing...','registrationmagic-gold'),
                            'one_rule_error'=>__('Enable at least one rule','registrationmagic-gold'),
                            'age_error'=>__('Age can not be empty','registrationmagic-gold'),
                            'invalid_age'=>__('Invalid ages specified','registrationmagic-gold'),
                            'empty_error'=>__('Value can not be empty','registrationmagic-gold')
