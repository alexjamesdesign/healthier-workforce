...
class RM_EX_LMSupport {
    ...
    public function create_admin_page() {
        add_submenu_page("", __( 'Landing Page', 'registrationmagic-gold' ), __( 'Landing Page', 'registrationmagic-gold' ), "manage_options", "rm_ex_lmsupport", array($this,'display_promo_page'));        
    }
    
    private function get_lm_install_url() {
    ...
    private function get_lm_activate_url()
    {
