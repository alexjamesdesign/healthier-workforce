...
class RM_Form_Widget extends WP_Widget
{
    ...
    function __construct()
    {
        parent::__construct(
            ...
            __('RegistrationMagic Form', 'registrationmagic-gold'), // Name
            array('description' => __('Attaches RegistrationMagic form.', 'registrationmagic-gold'),) // Args
        );
    }
    /**
    ...
    {   
        ...
        $title = !empty($instance['title']) ? $instance['title'] : __('RegistrationMagic Form', 'registrationmagic-gold');
        ?>
        <p>
