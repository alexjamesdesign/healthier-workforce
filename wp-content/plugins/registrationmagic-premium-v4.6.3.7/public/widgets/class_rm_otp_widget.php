...
class RM_OTP_Widget extends WP_Widget
{
    ...
    function __construct()
    {
        parent::__construct(
            ...
            __('RegistrationMagic Login Box', 'registrationmagic-gold'), // Name
            array('description' => __('Login system for RegistrationMagic form submissions with OTP login for non-WP users.', 'registrationmagic-gold'),) // Args
        );
    }
    /**
    ...
    {   
        $title = !empty($instance['title']) ? $instance['title'] : __('RegistrationMagic Login Box', 'registrationmagic-gold');
        ?>
        <p>
            <label for="<?php echo $this->get_field_id('title'); ?>"><?php _e('Title:','registrationmagic-gold'); ?></label>
