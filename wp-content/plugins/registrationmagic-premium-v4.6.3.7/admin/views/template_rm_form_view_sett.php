...
<div class="rmagic" ng-controller="formStyleCtrl"  ng-app="formStyleApp">
    ...
    <div class="buttonarea popup-button-group" style="">
        ...
        <?php if (isset($_GET['rdrto']) && $_GET['rdrto']): ?>
                <a value="&amp;#8592; &amp;nbsp; Cancel" href="?page=<?php esc_html_e($_GET['rdrto']); ?>&amp;rm_form_id=<?php echo $data->model->form_id; ?>" id="form_sett_post_sub-element-18">← &nbsp; <?php _e('Cancel', 'registrationmagic-gold'); ?></a>
            <?php else: ?>
