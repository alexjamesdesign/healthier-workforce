...
<div class="rmagic">
    ...
    <div class="rmcontent">
        ...
        $form->addElement(new Element_Url(RM_UI_Strings::get('LABEL_URL'), "field_value", array("required"=>1, "value" => isset($data->field['field_value'])?$data->field['field_value']:'', "longDesc"=>RM_UI_Strings::get('HELP_IFRAME_URL'))));
        $form->addElement(new Element_Textbox(RM_UI_Strings::get('IFRAME_LABEL_WIDTH'), "if_width", array("id" => "rm_if_width", "value" => isset($data->field['if_width'])?$data->field['if_width']:'', "longDesc" => RM_UI_Strings::get('HELP_FIELD_IF_WIDTH'))));
        $form->addElement(new Element_Textbox(RM_UI_Strings::get('IFRAME_LABEL_HEIGHT'), "if_height", array("id" => "rm_if_height", "value" => isset($data->field['if_height'])?$data->field['if_height']:'', "longDesc" => RM_UI_Strings::get('HELP_FIELD_IF_HEIGHT'))));
