...
<div class="rmagic">
    ...
    <div class="rmcontent">
        <?php
        $form->addElement(new Element_HTML('<div class="rmheader">' . RM_UI_Strings::get("TITLE_P_WIDGET_PAGE") . '</div>'));
        ...
        $form->addElement(new Element_Textarea("<b>" . RM_UI_Strings::get('LABEL_PARAGRAPF_TEXT') . "</b>", "field_value", array("id" => "rm_field_value_paragraph", "class" => "rm_static_field rm_field_value", "value" => isset($data->field['field_value'])?$data->field['field_value']:'', "longDesc"=>RM_UI_Strings::get('HELP_ADD_FIELD_PARA_TEXT'))));
