...
<div class="rmagic">
    ...
    <div class="rmcontent">
        ...
        $form->addElement(new Element_Select("<b>" . RM_UI_Strings::get('LABEL_CHART_TYPE') . ":</b>", "field_value",array("sot"=>__('Submissions over time', 'registrationmagic-gold'),"conversion_chart"=>__('Conversion%', 'registrationmagic-gold'),"browser_usage_chart"=>__('Browser Used', 'registrationmagic-gold'),"browser_conversion"=>__('Browser wise conversion', 'registrationmagic-gold')) ,array("id"=>"chart_type","class" => "rm_static_field rm_required", "value" => $data->model->get_field_value(), "longDesc"=>RM_UI_Strings::get('HELP_F_CHART_TYPE'))));
        
        $form->addElement(new Element_HTML('<div class="childfieldsrow" id="chart_time_range">'));
            $form->addElement(new Element_Select("<b>" . RM_UI_Strings::get('LABEL_SELECT_TIMERANGE') . ":</b>", "time_range",array("7"=>sprintf(__("Last %d days",'registrationmagic-gold'),7),"30"=>sprintf(__("Last %d days",'registrationmagic-gold'),30),"60"=>sprintf(__("Last %d days",'registrationmagic-gold'),60),"90"=>sprintf(__("Last %d days",'registrationmagic-gold'),90)) ,array("class" => "rm_static_field", "value" =>$data->model->field_options->time_range , "longDesc"=>'')));
        $form->addElement(new Element_HTML('</div>'));
