...
<div class="rmagic">
    ...
    <div class="rmcontent">
        ...
        $form->addElement(new Element_Url(RM_UI_Strings::get('LABEL_VIDEO_URL'), "field_value", array("validation"=> new Validation_RegExp("/.*youtube.com.*/", __('Must be a valid YouTube video url.', 'registrationmagic-gold')),"required"=>1, "value" => is_array($data->model->get_field_value()) ? null : $data->model->get_field_value(), "longDesc"=>RM_UI_Strings::get('HELP_WI_VIDEO_URL'))));
