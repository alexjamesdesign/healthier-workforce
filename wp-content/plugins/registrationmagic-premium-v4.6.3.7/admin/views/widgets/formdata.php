...
<div class="rmagic">
    ...
    <div class="rmcontent">
        ...
        $form->addElement(new Element_Radio(RM_UI_Strings::get('LABEL_TYPE'), "sub_limit_ind",array('date' => __('Date to go','registrationmagic-gold'), 'days' => __('Day(s) to go','registrationmagic-gold')), array("value" => $data->model->field_options->sub_limit_ind, "longDesc"=>'')));
