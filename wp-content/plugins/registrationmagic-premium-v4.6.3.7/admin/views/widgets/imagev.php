...
<div class="rmagic">
    ...
    <div class="rmcontent">
        ...
        $form->addElement(new Element_Select("<b>" . RM_UI_Strings::get('LABEL_SIZE') . ":</b>", "img_size",array(__('Thumbnail', 'registrationmagic-gold'),"50%","100%") ,array("class" => "rm_static_field rm_required", "value" => $data->model->field_options->img_size, "longDesc"=>RM_UI_Strings::get('HELP_IMG_SIZE'))));
        ...
        $form->addElement(new Element_Select("<b>" . RM_UI_Strings::get('LABEL_BORDER_SHAPE') . ":</b>", "border_shape",array(__('Square', 'registrationmagic-gold'),__('Circle', 'registrationmagic-gold')) ,array("class" => "rm_static_field rm_required", "value" => $data->model->field_options->border_shape, "longDesc"=>RM_UI_Strings::get('HELP_IMG_BORDER_SHAPE'))));
        $form->addElement(new Element_HTML('</div>'));
         
        $form->addElement(new Element_Radio(RM_UI_Strings::get('LABEL_ANCHOR_LINK'), "link_type",array(''=>__('None', 'registrationmagic-gold'),'url' => __('URL', 'registrationmagic-gold'), 'page' => __('Page', 'registrationmagic-gold')), array("onchange"=>"toggleURLOption(this)", "value" => $data->model->field_options->link_type, "longDesc"=>RM_UI_Strings::get('HELP_ADD_WIDGET_ANCHOR_LINK'))));
