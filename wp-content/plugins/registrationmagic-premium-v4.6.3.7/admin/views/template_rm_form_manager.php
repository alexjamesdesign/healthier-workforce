...
<div class="rmagic rm-all-forms">
    ...
    <ol id="rm-form-man-joytips" style="display:none">
        <li>
            <h2>
                <?php _e('Welcome to RegistrationMagic', 'registrationmagic-gold'); ?>
            </h2>
            <p><?php _e("RegistrationMagic is a powerful plugin that allows you to build custom registration system on your WordPress site. This is the main landing page - Forms Manager. Click <b>Next</b> to start a quick tour of this page. To stop at anytime, click the close icon on top right.", 'registrationmagic-gold'); ?></p>
        </li>
        <li data-id="rmbar" data-options="tipLocation:bottom"><?php _e('You will see this flat white box on top of different sections inside RegistrationMagic. We call it operations bar. It contains...', 'registrationmagic-gold'); ?></li>
        <li data-id="rm-tour-title" data-options="tipLocation:bottom"><?php _e('The heading of the section you are presently in...', 'registrationmagic-gold'); ?></li>
        <li data-id="rm-ob-icons" data-options="nubPosition:bottom-right;tipAdjustmentX:-330"><?php _e('Quick access icons relevant to the section...', 'registrationmagic-gold'); ?></li>
        <li data-id="rm-ob-sort" data-options="nubPosition:bottom-right;tipAdjustmentX:-320"><?php _e('A filter and sort drop down menu. In this section, it allows you to sort your forms.', 'registrationmagic-gold'); ?></li>
        <li data-id="rm-ob-nav"><?php _e("And a navigation menu with most important functions laid horizontally. Let's look at the Form Manager functions one by one.", 'registrationmagic-gold'); ?></li>
        <li data-id="rm-ob-new"><?php _e('This allows you to create new forms.', 'registrationmagic-gold'); ?></li>
        <li data-id="rm-ob-duplicate"><?php _e("This allows you to duplicate one or multiple forms. Form's configuration and fields are also duplicated. Note: This does not duplicates conditional logic applied to the form.", 'registrationmagic-gold'); ?></li>
        <li data-id="rm-ob-delete"><?php _e('This allows you to delete one or multiple forms. All associated form data is deleted.', 'registrationmagic-gold'); ?></li>
        <li data-id="rm-ob-export"><?php _e('This allows you to export all your forms and associated data in a single XML file. Handy if you are reinstalling your site, moving forms to another site or simply backing up your hard work. Note: This does not exports conditional logic applied to the form.', 'registrationmagic-gold'); ?></li>
        <li data-id="rm-ob-import"><?php _e('Import button allows you to import the XML file saved on your computer.', 'registrationmagic-gold'); ?></li>
        <li><h3>
                <?php _e('Forms As Cards', 'registrationmagic-gold'); ?>
            </h3>
            <p><?php _e('RegistrationMagic displays all forms as rectangular cards. This is a novel new approach. You will later see that a form card is much more than a symbolic representation of a form. It can show you form related data and stats at a glance.', 'registrationmagic-gold'); ?></p>
        </li>
        <li data-id="rm-card-area"><?php _e("All form cards are displayed as grid, starting from here. You may not need to create more than one registrations form, but it's totally up to you. RegistrationMagic gives a playground to experiment and play to find the best combination for your site. First card slot is reserved for <b>Login Form</b>", 'registrationmagic-gold'); ?></li>
        <li data-class="rm-card-tour"><?php _e('This is a form card. We automatically created it for you to give you a head start.', 'registrationmagic-gold'); ?></li>
        <li data-class="rm-title-tour"><?php _e('This shows title of the form. When you create a new form, you can define its title. You can always change title of this form later, by going into its <b>General Settings</b>', 'registrationmagic-gold'); ?></li>
        <li data-class="rm-checkbox-tour" data-options="tipAdjustmentX:-28;tipAdjustmentY:-5"><?php _e("The checkbox on left side of the title allows you to select multiple forms and perform batch operations. For example, deleting multiple forms. Of course there's nothing stopping you from deleting or duplicating a single form.", 'registrationmagic-gold'); ?></li>
        <li data-class="rm_formcard_menu_icon" data-options="tipAdjustmentX:-25;tipAdjustmentY:-2"><?php _e('Clicking this will open a popup menu allowing you direct access to different sections of this form.', 'registrationmagic-gold'); ?></li>
        <li data-class="unread-box" data-options="tipAdjustmentX:-22;tipAdjustmentY:-5"><?php _e('On top right side of each card is a red number badge. This is the count of total times this form has been filled and submitted on your site by visitors.', 'registrationmagic-gold'); ?></li>
        <li data-class="rm-last-submission"><?php _e("This area displays 3 latest submissions for this form. On new forms it will be empty in the start. Each submission will also show user's Gravatar and time stamp.", 'registrationmagic-gold'); ?></li>
        <li data-class="rm-shortcode-tour" data-options="tipAdjustmentX:50"><?php _e("Now this is important. RegistrationMagic works through shortcodes. That means, to display a form on the site, you must paste its shortcode inside a page, post or a widget (where you want this form to appear). Form shortcodes are always in this format - ", 'registrationmagic-gold'); ?><b>[RM_Form id='x']</b></li>
        <li data-class="rm_def_star_tour" data-options="tipAdjustmentX:-24;tipAdjustmentY:-5"><?php _e('This little star allows you to mark a form as your default registration form.', 'registrationmagic-gold'); ?></li>
        <li data-class="rm-form-settings"><?php _e('Each form has its own dashboard or operations area, that is accessible by clicking the <b>Settings</b> button on the respective form card.', 'registrationmagic-gold'); ?></li>
        <li data-class="rm-form-fields" data-options="tipAdjustmentX:-12"><?php _e('Any form once created is empty. Form fields need to be added manually. This is where <b>Custom Fields Manager</b> comes in. Clicking it will take you to a separate section, where you can add all sorts of fields and pages to your form.', 'registrationmagic-gold'); ?></li>
        <li data-button="Done"><?php printf(__('This ends our tour of Forms Manager. Feel free to explore other sections of RegistrationMagic. We would recommend visiting the form Dashboard first. If anything does not works as expected, please write to us <a href="%s"><u>here</u></a> and we will help you sort it out asap.', 'registrationmagic-gold'),'https://registrationmagic.com/help-support'); ?></li>
...
<!--                    <li id="rm-ob-new"><a href="admin.php?page=rm_form_sett_general"><?php echo RM_UI_Strings::get('LABEL_ADD_NEW'); ?></a></li>-->
                    ...
                    <li id="rm-ob-demo"><a target="_blank" href="https://registrationmagic.com/create-wordpress-registration-page-starter-guide/"><?php echo RM_UI_Strings::get('STARTER_GUIDE'); ?><span class="dashicons dashicons-book-alt"></span></a></li>
                    ...
                    <li class="rm-form-toggle" id="rm-ob-sort"><?php _e('Sort Forms', 'registrationmagic-gold'); ?><select onchange="rm_sort_forms(this, '<?php echo $data->curr_page; ?>')">
    ...
    <div class="rmagic-cards" id="rm-card-area">
        ...
        <div id="login_form" class="rmcard">
            ...
            <div class="cardtitle">
                <input class="rm_checkbox" type="checkbox" disabled="disabled"><?php _e('Login Form', 'registrationmagic-gold'); ?></div>
            ...
            <div class="rm-form-links">
                <div class="rm-form-row rm-formcard-dashboard">
                    <a class="rm-form-settings" href="admin.php?page=rm_login_sett_manage">
                        <?php _e('Dashboard', 'registrationmagic-gold'); ?></a>
                </div>   
                <div class="rm-form-row rm-formcard-setup"><a class="rm-form-fields" href="admin.php?page=rm_login_field_manage"><?php _e('Fields', 'registrationmagic-gold'); ?></a></div> 
...
//Check if form is one of the sample forms.
                ...
                <div id="<?php echo $entry->form_id; ?>" class="<?php echo trim($form_card_class . " rm-card-tour " . $ex_form_card_class); ?>">
                    ...
                    <div class="rm-form-links">
                        ...
                        <div class="rm-form-row rm-formcard-setup"><a class="rm-form-fields" href="admin.php?page=rm_field_manage&rm_form_id=<?php echo $entry->form_id; ?>"><?php _e('Fields', 'registrationmagic-gold'); ?></a></div> 
        ...
        <div id="fb_sub_footer" class="rm-footer-banner">
            <div class="rm-fb-like-us">
                <a onclick="save_fb_subscribe_action()">
                    <img src="<?php echo plugin_dir_url(dirname(dirname(__FILE__))) . 'images/fb-thumb-up.png'; ?>"> <?php _e('Like us on Facebook for upgrade notifications, important tips and feature updates.', 'registrationmagic-gold'); ?>
                </a>
            </div>
        </div>
    <?php
        ...
        <div class="rm_add_new_form_wrap rm-create-new-from rm-form-popup-out">
            <div class="rm-modal-titlebar rm-new-form-popup-header">
                <div class="rm-modal-title">
                    <?php _e('Create New Form','registrationmagic-gold'); ?>
                </div>
...
<pre class="rm-pre-wrapper-for-script-tags"><script type="text/javascript">
        ...
        jQuery.post(ajaxurl, data, function (response) {
            if (response == 0)
            {
               _getEl("progressBar").value = Math.round(100);
                _getEl("status").innerHTML = '<?php _e('Import Successfully Completed', 'registrationmagic-gold'); ?>';
                setTimeout(function(){
    ...
    function start_import(){
        ...
        jQuery.post(ajaxurl, data, function (response) {
            if (response == 0)
            {
                ...
                jQuery("#rm_import_errors").html('');
                jQuery("#rm_import_errors").append("<div class='rm_import_error'><?php _e('Invalid RegistrationMagic template file. Please upload valid template file with XML extension.','registrationmagic-gold') ?></div>");
    ...
    function check_file_extension(obj){
        ...
        if(file && file.type!="text/xml"){
            jQuery("#rm_import_errors").html("<div class='rm_import_error'><?php _e('Invalid RegistrationMagic template file. Please upload valid template file with XML extension.','registrationmagic-gold') ?></div>");
            obj.value='';
        }
    }
    ...
    function uploadFile() {
      ...
      if(!file){
           jQuery("#rm_import_errors").html("<div class='rm_import_error'><?php _e('Please select a file','registrationmagic-gold') ?></div>");
           return;
      }
      jQuery("#rm_import_errors").html('');
    ...
    function progressHandler(event) {
      ...
      _getEl("status").innerHTML = "<?php _e('File upload is in progress...','registrationmagic-gold') ?>";
    }

    function completeHandler(event) {
       var percent = 50;
      _getEl("progressBar").value = Math.round(percent);
      _getEl("status").innerHTML = "<?php _e('Form Import is in progress...','registrationmagic-gold') ?>";
      start_import();
    }

    function errorHandler(event) {
      _getEl("status").innerHTML = "<?php _e('Upload Failed','registrationmagic-gold') ?>";
    }

    function abortHandler(event) {
      _getEl("status").innerHTML = "<?php _e('Upload Aborted','registrationmagic-gold') ?>";
    }     
