...
if(strtolower($data->model->field_type)=="email" && $data->model->is_field_primary == 1) {
    $form->addElement(new Element_Checkbox("<b>".__('Display email confirmation field','registrationmagic-gold')."</b>", "en_confirm_email", array('1'=>''), array("class" => "rm_field_multiline rm_input_type en_confirm_email", "value" => $data->model->field_options->en_confirm_email, "longDesc"=>__('Display an email confirmation field below the email field.','registrationmagic-gold'))));
    $form->addElement(new Element_HTML('<div class="childfieldsrow" id="confirm_pwd_options">'));
    $form->addElement(new Element_Textarea("<b>".__('Email mismatch error message','registrationmagic-gold')."</b>", "email_mismatch_err", array("class" => "", "value" =>$data->model->field_options->email_mismatch_err , "longDesc" => __('Contents of the error message user sees when the email entered in email confirmation field does not match.','registrationmagic-gold'))));
    $form->addElement(new Element_HTML('</div>'));
}
