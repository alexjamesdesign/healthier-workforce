...
<div class="field-selector-pills">
    ...
    <?php if($data->form->form_type==1 && (!in_array('Username', $primary_fields) || !in_array('UserPassword', $primary_fields))): ?>
        <div class="rm-field-tabs-row rm-dbfl">
            <div class="rm-field-tab-cat"><?php _e('Account Fields', 'registrationmagic-gold'); ?></div>
            <div id="rm_common_fields_tab">
                <?php if(!in_array('Username', $primary_fields)) : ?>
                    <div title="<?php _e('Username', 'registrationmagic-gold'); ?>" class="rm_button_like_links" onclick="add_user_field_to_page('Username')"><a href="javascript:void(0)"><?php _e('Accounts Username', 'registrationmagic-gold'); ?></a></div> 
                <?php endif; ?>    
                <?php if(!in_array('UserPassword', $primary_fields)) : ?>
                    <div title="<?php _e('User Password', 'registrationmagic-gold'); ?>" class="rm_button_like_links" onclick="add_user_field_to_page('UserPassword')"><a href="javascript:void(0)"><?php _e('Accounts Password', 'registrationmagic-gold'); ?></a></div> 
                <?php endif; ?>
            </div>
        </div> 
    <?php endif; ?>
    ...
    <div class="rm-field-tabs-row rm-dbfl">
        ...
        <div id="rm_special_fields_tab">
            ...
            <div title="<?php echo RM_UI_Strings::get("FIELD_HELP_TEXT_Image"); ?>"         class="rm_button_like_links" onclick="add_new_field_to_page('ESign')"><a href="javascript:void(0)"><?php _e('ESign','registrationmagic-gold'); ?></a></div>
            ...
            <div title="<?php _e('Privacy Policy', 'registrationmagic-gold'); ?>"        class="rm_button_like_links" onclick="add_new_field_to_page('Privacy')"><a href="javascript:void(0)"><?php _e('Privacy Policy', 'registrationmagic-gold'); ?></a></div>
            <?php endif; ?>
        </div>
    </div>
    ...
    <div class="rm-field-tabs-row rm-fields-tab-woo rm-dbfl">
        ...
        <div class="rm-field-tab-cat"> <?php echo __('WooCommerce Fields', 'registrationmagic-gold'); ?></div>
        <div id="rm_wc_fields_tab">
            <div title="<?php echo __('WooCommerce Billing Field', 'registrationmagic-gold'); ?>" class="rm_button_like_links" onclick="add_new_field_to_page('WCBilling')"><a href="javascript:void(0)"><?php echo __('WooCommerce Billing Field', 'registrationmagic-gold'); ?></a></div>
            <div title="<?php echo __('WooCommerce Shipping Field', 'registrationmagic-gold'); ?>" class="rm_button_like_links" onclick="add_new_field_to_page('WCShipping')"><a href="javascript:void(0)"><?php echo __('WooCommerce Shipping Field', 'registrationmagic-gold'); ?></a></div>
            <div title="<?php echo __('Billing Phone Number', 'registrationmagic-gold'); ?>" class="rm_button_like_links" onclick="add_new_field_to_page('WCBillingPhone')"><a href="javascript:void(0)"><?php echo __('Billing Phone Number', 'registrationmagic-gold'); ?></a></div>
        </div>
        <?php else: ?>
        <div class="rm-field-tab-cat"> <?php echo __('WooCommerce Fields (Install and activate WooCommerce to enable these fields)', 'registrationmagic-gold'); ?></div>
        <div id="rm_wc_fields_tab">
            <div title="<?php echo __('WooCommerce Billing Field', 'registrationmagic-gold'); ?>" class="rm_button_like_links"><a href="javascript:void(0)" class="rm_deactivated"><?php echo __('WooCommerce Billing Field', 'registrationmagic-gold'); ?></a></div>
            <div title="<?php echo __('WooCommerce Shipping Field', 'registrationmagic-gold'); ?>" class="rm_button_like_links"><a href="javascript:void(0)" class="rm_deactivated"><?php echo __('WooCommerce Shipping Field', 'registrationmagic-gold'); ?></a></div>
            <div title="<?php echo __('Billing Phone Number', 'registrationmagic-gold'); ?>" class="rm_button_like_links"><a href="javascript:void(0)" class="rm_deactivated"><?php echo __('Billing Phone Number', 'registrationmagic-gold'); ?></a></div>
        </div>
        <?php endif; ?>
    </div>
    ...
    <div title="<?php echo RM_UI_Strings::get("FIELD_HELP_TEXT_YOUTUBE"); ?>" class="rm_button_like_links" onclick="add_new_widget_to_page('YouTubeV')"><a href="javascript:void(0)"><?php _e('YouTube Video', 'registrationmagic-gold'); ?></a></div> 
    <div title="<?php echo RM_UI_Strings::get("FIELD_HELP_TEXT_IFRAME"); ?>" class="rm_button_like_links" onclick="add_new_widget_to_page('Iframe')"><a href="javascript:void(0)"><?php _e('iFrame Embed', 'registrationmagic-gold'); ?></a></div> 
    <div title="<?php echo RM_UI_Strings::get("FIELD_HELP_TEXT_IMAGEV"); ?>" class="rm_button_like_links" onclick="add_new_widget_to_page('ImageV')"><a href="javascript:void(0)"><?php _e('Image', 'registrationmagic-gold'); ?></a></div>
    <div title="<?php echo RM_UI_Strings::get("FIELD_HELP_TEXT_PRICEV"); ?>" class="rm_button_like_links" onclick="add_new_widget_to_page('PriceV')"><a href="javascript:void(0)"><?php _e('Total Price', 'registrationmagic-gold'); ?></a></div>
    <div title="<?php _e('If you have set form limits, you can display the limit status using this widget', 'registrationmagic-gold'); ?>" class="rm_button_like_links rm-widget-lg" onclick="add_new_widget_to_page('SubCountV')"><a href="javascript:void(0)"><?php _e('Submission Countdown', 'registrationmagic-gold'); ?></a></div>
    <div title="<?php _e('Display a location with marker using GoogleMaps', 'registrationmagic-gold'); ?>" class="rm_button_like_links" onclick="add_new_widget_to_page('MapV')"><a href="javascript:void(0)"><?php _e('Map', 'registrationmagic-gold'); ?></a></div>  
    <div title="<?php _e('Display stats about the form using graphs and charts', 'registrationmagic-gold'); ?>" class="rm_button_like_links" onclick="add_new_widget_to_page('Form_Chart')"><a href="javascript:void(0)"><?php _e('Form Data Chart', 'registrationmagic-gold'); ?></a></div> 
    <div title="<?php _e('Display various properties of the form', 'registrationmagic-gold'); ?>" class="rm_button_like_links" onclick="add_new_widget_to_page('FormData')"> <a href="javascript:void(0)"><?php _e('Form Meta-Data', 'registrationmagic-gold'); ?></a></div>
    <div title="<?php _e('Display latest registrations/ submissions data in your form', 'registrationmagic-gold'); ?>" class="rm_button_like_links" onclick="add_new_widget_to_page('Feed')"><a href="javascript:void(0)"><?php echo $data->form->form_type==0 ? __('Submission Feed', 'registrationmagic-gold') : __('Registration Feed', 'registrationmagic-gold'); ?></a></div>
    </div>
    </div>
