        ...
        <div class="rm-grid-section dbfl rm_publish_section" id="rm_publish_timelinepopup">
            <div class="rm-directory-container dbfl">
                <div class="rm-publish-directory-col rm-pd-col-left rm-difl ">
                    <?php echo sprintf(__("You can check individual user's login timeline by visiting the user's page inside User Manager. <a target='_blank' class='rm-more' href='%s'>More Info</a><br><br><a target='_blank' class='rm-more' href='%s'>Visit User Manager Now</a>", 'registrationmagic-gold'),'https://registrationmagic.com/wordpress-user-login-plugin-guide/#user-manager','?page=rm_user_manage'); ?>
                </div>
