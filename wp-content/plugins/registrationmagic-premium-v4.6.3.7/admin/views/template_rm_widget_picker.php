...
<ul class="rm-widget-selector-view">
    ...
    <li class="rm_button_like_links" onclick="add_new_widget_to_page('YouTubeV')" title="<?php echo RM_UI_Strings::get("FIELD_HELP_TEXT_YOUTUBE"); ?>">
        ...
        <div class="rm-difl rm-widget-head"><a href="javascript:void(0)"><?php _e('YouTube Video', 'registrationmagic-gold'); ?></a>
        </div>
    </li> 
    ...
    <li class="rm_button_like_links" onclick="add_new_widget_to_page('Iframe')" title="<?php echo RM_UI_Strings::get("FIELD_HELP_TEXT_IFRAME"); ?>">
        ...
        <div class="rm-difl rm-widget-head"><a href="javascript:void(0)"><?php _e('iFrame Embed', 'registrationmagic-gold'); ?></a>
    ...
    <li class="rm_button_like_links" onclick="add_new_widget_to_page('ImageV')" title="<?php echo RM_UI_Strings::get("FIELD_HELP_TEXT_IMAGEV"); ?>">
        ...
        <div class="rm-difl rm-widget-head"><a href="javascript:void(0)"><?php _e('Image', 'registrationmagic-gold'); ?></a>
        </div>
    </li>
    ...
    <li class="rm_button_like_links" onclick="add_new_widget_to_page('PriceV')" title="<?php echo RM_UI_Strings::get("FIELD_HELP_TEXT_PRICEV"); ?>">
        <div class="rm-difl rm-widget-icon rm-widget-add-image"><i class="material-icons">&#xE263;</i></div> 
        <div class="rm-difl rm-widget-head"><a href="javascript:void(0)"><?php _e('Price', 'registrationmagic-gold'); ?></a>
        </div>
    </li>
    
    <li class="rm_button_like_links rm-widget-lg" onclick="add_new_widget_to_page('SubCountV')" title="<?php _e('If you have set form limits, you can display the limit status using this widget', 'registrationmagic-gold'); ?>">
        <div class="rm-difl rm-widget-icon rm-widget-add-image"><i class="material-icons">&#xE439;</i></div> 
        <div class="rm-difl rm-widget-head"><a href="javascript:void(0)"> <?php _e('Submission Countdown', 'registrationmagic-gold'); ?></a>
        </div>
    </li>
    
    <li class="rm_button_like_links" onclick="add_new_widget_to_page('MapV')" title="<?php _e('Display a location with marker using GoogleMaps', 'registrationmagic-gold'); ?>">
        <div class="rm-difl rm-widget-icon rm-widget-map"><i class="material-icons">&#xE0C8;</i></div> 
        <div class="rm-difl rm-widget-head"><a href="javascript:void(0)"><?php _e('Map', 'registrationmagic-gold'); ?></a>
        </div>
    </li>  
    
    <li class="rm_button_like_links" onclick="add_new_widget_to_page('Form_Chart')" title="<?php _e('Display stats about the form using graphs and charts', 'registrationmagic-gold'); ?>">
        <div class="rm-difl rm-widget-icon rm-widget-form-date-chart"><i class="material-icons">&#xE6C4;</i></div> 
        <div class="rm-difl rm-widget-head"> <a href="javascript:void(0)"><?php _e('Form Data Chart', 'registrationmagic-gold'); ?></a>
 
        </div>
    </li> 
    
     <li class="rm_button_like_links" onclick="add_new_widget_to_page('FormData')" title="<?php _e('Display various properties of the form', 'registrationmagic-gold'); ?>">
        <div class="rm-difl rm-widget-icon rm-widget-form-data"><i class="material-icons">&#xE85D;</i></div> 
        <div class="rm-difl rm-widget-head"> <a href="javascript:void(0)"><?php _e('Form Meta-Data', 'registrationmagic-gold'); ?></a>
   
        </div>
     </li>
     
     <li class="rm_button_like_links" onclick="add_new_widget_to_page('Feed')" title="<?php _e('Display latest registrations/ submissions data in your form', 'registrationmagic-gold') ?>">
        <div class="rm-difl rm-widget-icon rm-widget-registration-feed"><i class="material-icons">&#xE0E5;</i></div> 
        <div class="rm-difl rm-widget-head"><a href="javascript:void(0)"><?php echo $data->form->form_type==0 ? __('Submission Feed', 'registrationmagic-gold') : __('Registration Feed', 'registrationmagic-gold'); ?></a>
        </div>
    </li>
