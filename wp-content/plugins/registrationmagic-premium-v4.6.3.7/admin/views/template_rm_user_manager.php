    ...
    <div class="rmagic-table">
        ...
        <div class="sidebar">
            ...
            <form id="rm_user_manager_sideform"  action="<?php echo add_query_arg('rm_reqpage', '1'); ?>" method="GET">
                ...
                <div class="sb-filter"><?php _e('Search', 'registrationmagic-gold'); ?>
                ...
                <div class="filter-row test">
                    <a href="?page=rm_user_manage">
                        <input type="button" name="Reset" value="<?php _e('Reset', 'registrationmagic-gold') ?>">
                    </a>
                    <input type="submit" name="Search" value="<?php _e('Search', 'registrationmagic-gold'); ?>">
                </div>
                ...
                <div class="rm-modal-wrap rm-user-delete-popup">
                    ...
                    <div class="rm-modal-titlebar ">
                        <div class="rm-modal-title">
                            <?php _e("Delete Users", 'registrationmagic-gold'); ?>
                        </div>
                                ...
                                <ul style="list-style:none;">
                                    <li>
                                        <label>
                                            ...
                                            <?php _e("Delete all content", 'registrationmagic-gold'); ?>
                                        </label>
                                    </li>
                                    <li>
                                        <input checked type="radio" name="rm_delete_option" value="reassign">
                                        <label for="delete_option"><?php _e("Attribute all content to:", 'registrationmagic-gold'); ?></label> 
                                        <?php $users = get_users(); ?>
                    ...
                    <div class="rm-modal-footer rm-dbfl">
                        <div class="rm-difl rm_user_delete-cancel-bt"><a href="javascript:void(0)" class="rm-model-cancel">← &nbsp;<?php _e("Cancel", 'registrationmagic-gold'); ?></a></div>
                        <div class="rm-difl rm_user_delete-bt">
                            <a onclick="jQuery.rm_user_deletion_confirmed()"><?php _e("Confirm Deletion", 'registrationmagic-gold'); ?></a>
                        </div>
                    </div>
                </div>
