...
<script type="text/javascript">
    ...
    { 
        ...
        var html = '<div class="rm-field-condition-row"><div class="rm-controlling-atr"><div class="rminput"><select name="cfields[]"><option><?php _e('Select Field','registrationmagic-gold'); ?></option><?php echo $fields_dd_options; ?></select></div></div><div class="rm-controlling-atr"><div class="rminput"><select onchange="opChanged(this)" name="op[]"><?php echo addslashes(RM_Utilities::get_cond_op_dd()); ?></select></div></div><div class="rm-controlling-atr"><div class="rminput"><input type="text" name="values[]" placeholder="Value" maxlength="50"></div></div><div class="rm-controlling-atr rm-controlling-btn"> <div class="rminput"><a onclick="delete_dependency(this)" href="javascript:void(0)"><?php _e('Remove','registrationmagic-gold'); ?></a></div></div></div>';
            ...
            <div class="rm-conditional">
                <div class="rm-conditions">
                    <div class="rm-add-field" style="display:none">
                        <a href="javascript:void(0)" onclick="addField()"><?php _e('Add', 'registrationmagic-gold'); ?></a>
                        ...
                        <div style="<?php echo $display; ?>" class="rm-condition" id="rm_condition_<?php echo $field->field_id; ?>" data-field-name="<?php echo ucwords(esc_attr($field->field_label)); ?>"> 
                                ...
                                <div class="rm-field-conditions-wrap">
                                    <div class="rm-field-conditions-title">
                                        ...
                                        <div class="rm-field-conditions-delete"><a href="javascript:void(0)" onclick="delete_all(<?php echo $field->field_id; ?>)"><?php _e('Delete','registrationmagic-gold'); ?></a> </div>
                                    ...
                                    <div class="rm-match-condition-row">
                                                <div class="rm-match-condition"><input type="radio" name="combinator" value="OR" <?php echo @$options->conditions['settings']['combinator'] != 'AND' ? 'checked' : '' ?>><label for="rm-match-all-condition" ><?php _e('Match Any Condition', 'registrationmagic-gold'); ?></label></div>     
                                                <div class="rm-match-condition"><input  type="radio" name="combinator" value="AND" <?php echo @$options->conditions['settings']['combinator'] == 'AND' ? 'checked' : '' ?>><label for="rm-match-one-condition" ><?php _e('Match All Conditions', 'registrationmagic-gold'); ?></label></div> 
                                    </div>
                                    <?php
                                        ...
                                        ?>   
                                            <div class="rm-field-condition-row">
                                                ...
                                                <div class="rm-controlling-atr rm-controlling-btn"> 
                                                    <div class="rminput"><a onclick='delete_dependency(this)' href="javascript:void(0)"><?php _e('Remove', 'registrationmagic-gold'); ?></a></div>
                                                </div>
                                            </div>
                                   ...
                                   <div class="rm-add-condition-row">  <a onclick="addConditionForm(<?php echo $field->field_id; ?>)" href="javascript:void(0)"><?php _e('Add', 'registrationmagic-gold'); ?></a></div> 
                                   <div class="rm-save-condition-row"> <input type="submit" value="<?php _e('Save', 'registrationmagic-gold'); ?>" /></div>
                                </div>
                        </div></form>
                        <?php
                    endforeach;
