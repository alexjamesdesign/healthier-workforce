    ...
    <div class="operationsbar">
        ...
        <div class="nav">
            <ul>
                ...
                <li id="rm-update-submission-payment" class="rm_deactivated" onclick="jQuery.rm_do_action('rm_submission_manager_form', 'rm_submission_update_payment')"><a href="javascript:void(0)"><?php _e('Mark Payment Complete','registrationmagic-gold'); ?></a></li>
