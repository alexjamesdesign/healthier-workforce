...
<script type="text/javascript" src="<?php echo RM_BASE_URL . 'admin/js/'; ?>script_rm_formflow.js"></script>
    ...
    <div  class="rm-grid difl">
        ...
        <div class="rm-grid-section dbfl rm_publish_section" id="rm_publish_shortcode"> 
            <div class="rm-section-publish-note"> <?php _e('Publish inside a page or a post', 'registrationmagic-gold'); ?> </div>
            <div class="rm-publish-text"><?php _e('The most common method. Copy this shortcode and paste it inside a page or post where you want to display the form.', 'registrationmagic-gold'); ?></div>
            ...
            <div class="rm-section-shortcode">
                ...
                <div class="rm-click-to-copy-button" onclick="rm_copy_content(document.getElementById('rmformshortcode'), this)"><?php _e('Copy', 'registrationmagic-gold'); ?></div>
            </div>
        </div>
        
        <div class="rm-grid-section dbfl rm_publish_section" id="rm_publish_widget">
            <div class="rm-section-publish-note">
                <span id="rmformshortcode"><?php _e('Publish inside a Page Builder or Widget area', 'registrationmagic-gold'); ?></span>
                
            </div>
            <div class="rm-publish-text"><?php _e('Find RegistrationMagic Form widget in your <b>Appearance/Widgets</b> section. Drag it to the widget area where you wish to display the form. Select the form to display in Widget settings and save.', 'registrationmagic-gold'); ?></div>
        ...
        <div class="rm-grid-section dbfl rm_publish_section" id="rm_publish_embed">  
            ...
            <div class="rm-section-publish-note"> <?php _e('Publish using embed code', 'registrationmagic-gold'); ?> </div>
            <div class="rm-directory-container dbfl">          
                <div class="rm-section-embedcode rm-section-shortcode">
                    ...
                    <div class="rm-click-to-copy-button" onclick="rm_copy_content(document.getElementById('rmformembedcode'), this)"><?php _e('Copy', 'registrationmagic-gold'); ?></div>
                </div>
            </div>
        ...
        <div class="rm-grid-section dbfl rm_publish_section" id="rm_publish_userdir">
            ...
            <div class="rm-section-publish-note"> <?php _e('Publish a Directory of users who submitted this form', 'registrationmagic-gold'); ?></div>
            <div class="rm-publish-text"><?php _e('Displays a directory of all the users who have submitted this form. Only users with WordPress account will be displayed.', 'registrationmagic-gold'); ?></div>
            ...
            <div class="rm-directory-container dbfl">
                ...
                <div class="rm-publish-directory-col rm-difl">  
                    <div class="rm-section-shortcode"> 
                        ...
                        <div class="rm-click-to-copy-button" onclick="rm_copy_content(document.getElementById('rmformuserdircode'), this)"><?php _e('Copy', 'registrationmagic-gold'); ?></div>                        
                    </div>
                    <div class="rm_shortcode_help_text"><?php _e('If you want to display only specific users, you can pass one more parameter to the shortcode - filter the list by time of registration. The longer format is:', 'registrationmagic-gold'); ?> <div data-publish_code="[RM_Users form_id='%fid%' timerange='year']"><?php echo "[RM_Users form_id='{$form_id_to_publish}'  timerange='year']"; ?></div><?php _e('Where timerange can be year, month, week or today. Also, you can omit form_id parameter to list all the users registered through all the forms.', 'registrationmagic-gold') ?></div>
                </div>
            </div>
        </div>  
        <div class="rm-grid-section dbfl rm_publish_section" id="rm_publish_subs">
            <div class="rm-directory-container dbfl">
                ...
                <div class="rm-publish-directory-col rm-difl">  
                    <div class="rm-section-publish-note"><?php _e('Create a user area on your site', 'registrationmagic-gold'); ?></div>
                    <div class="rm-publish-text"><?php _e('This shortcode renders a comprehensive user specific area on your site.', 'registrationmagic-gold'); ?></div>
                    <div class="rm-section-shortcode"> 
                        <span id="rmsubmissionscode"><?php echo "[RM_Front_Submissions]"; ?></span>
                        <div class="rm-click-to-copy-button" onclick="rm_copy_content(document.getElementById('rmsubmissionscode'), this)"><?php _e('Copy', 'registrationmagic-gold'); ?></div>
                    </div>
                </div>
        ...
        <div class="rm-grid-section dbfl rm_publish_section" id="rm_publish_magicpopup">
            <div class="rm-directory-container dbfl">
                ...
                <div class="rm-publish-directory-col rm-difl">  
                    <div class="rm-section-publish-note"><?php _e('Display the form in a sliding popup', 'registrationmagic-gold'); ?></div>
                    <div class="rm-publish-text"><?php _e('Click the star to activate the form in Magic Popup. To remove the form, select another form.', 'registrationmagic-gold'); ?></div>
                    <div class="rm-section-shortcode rm-formflow-embedcode"> 
                        <span id="rmdefformstar">
                            <i class="material-icons rm_not_def_form_star rm_form_star" onclick="rm_formflow_set_def_form(this)" id="rm-star_<?php echo $form_id_to_publish; ?>" data-def_form_id="<?php echo empty($data->def_form_id) ? '' : $data->def_form_id;?>">&#xe838</i>
                                <span>
                                    <?php _e('Click above star to set this form as default registration form. The default registration form appears in the Magic Popup on front-end.', 'registrationmagic-gold'); ?>
                                </span> 
                        </span>                        
                    </div>
                ...
                <div class="rm-magic-popup-notice rm-dbfl"> <?php printf(__('Magic pop-up is currently disabled. Please go to <a href="%s" target="_blank">Global Settings >> Magic Popup Button</a> to enable it.', 'registrationmagic-gold'),'?page=rm_options_fab'); ?> </div>
                      <?php endif; ?>
        ...
        <div class="rm-grid-section dbfl rm_publish_section" id="rm_publish_login">
            ...
            <?php endif; ?>
            <div class="rm-section-publish-note"> <?php _e('Publish a login form', 'registrationmagic-gold'); ?> </div>
            
            <div class="rm-publish-text"><?php _e('Login system is built into RegistrationMagic. To display a login box on any page, post or widget use this code.', 'registrationmagic-gold'); ?></div>
                        
            <div class="rm-section-shortcode">
                <span id="rmloginformshortcode"><?php echo "[RM_Login]"; ?></span>            
                <div class="rm-click-to-copy-button" onclick="rm_copy_content(document.getElementById('rmloginformshortcode'), this)"><?php _e('Copy', 'registrationmagic-gold'); ?></div>
            </div>
        </div>
