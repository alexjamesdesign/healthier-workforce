    ...
    <div class="rm-create-new-from">
        ...
        <div class="rmrow">
            ...
            <div class="rm-form-name rm-dbfl">
                ...
                <div class="rm-form-head rm-difl"><?php _e('Name of your form','registrationmagic-gold'); ?></div> 
        ...
        <div class="rm-create-new-from-btn-area">    
            <input type="submit" value="<?php _e("Save", 'registrationmagic-gold') ?>" name="submit" id="rm_submit_btn" onclick="rm_handle_new_form_creation(event)" class="rm_btn btn btn-primary">
        </div>
