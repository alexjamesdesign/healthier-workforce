    ...
    <!--- Password delete PopUp -->
        <div id="rm-userpassword-delete" class="rm-modal-view" style="display:none">
            ...
            <div class="rm-modal-wrap">
                ...
                <div class="rm-modal-container">
                    <?php _e('You are about to remove the Password field from this form. Once removed, passwords will be autogenerated and emailed to the users on successful registration through this form. Do you wish to proceed?', 'registrationmagic-gold'); ?>
                </div>
                <div class="rm-password-delete-actions">
                        <input type="button" onclick="userpassword_delete(true,'#rm-userpassword-delete')" value="<?php _e('Remove', 'registrationmagic-gold'); ?>" />
                        <input type="button" onclick="jQuery('#rm-userpassword-delete').toggle()" value="<?php _e('Cancel', 'registrationmagic-gold'); ?>" />
                    </div>
