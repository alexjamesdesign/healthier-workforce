...
<div class="rmagic">
    ...
    <div class="rmcontent " ng-controller="loggedInViewCtrl"  ng-app="loggedInViewApp">
        ...
        <div class="rmheader"><?php echo _e('Logged In View', 'registrationmagic-gold'); ?></div>
        ...
        <div class="rm-logged-in-view rm-dbfl">
                ...
                <div class="rm-logged-in-view-wrap">
                    ...
                    <div class="rm-logged-in-lf rm-difl">
                        <img alt="" src="<?php echo plugin_dir_url(dirname(dirname(__FILE__))) . 'images/default_person.png'; ?>" class="avatar avatar-96 photo" height="96" width="96">            </div>
                    ...
                    <div class="rm-logged-in-rf rm-difl">
                        ...
                        <div class="rm-logged-welcome">
                            ...
                            <!-- Show user name -->
                            <span class="rm-user-display-name rm-dbfl" ng-if="displayUsername"><?php _e('Full Name','registrationmagic-gold'); ?></span>

                        </div>


                        <!-- User bio description -->
                         <!-- <div><?php _e('This is bio description.','registrationmagic-gold') ?></div>-->
            ...
            <div class="rmrow"> <div class="rmnotice"><?php _e('The color of hyperlink anchor text for My Account and Logout will appear based on your theme on the front end. Colors displayed here are only for representation.','registrationmagic-gold') ?></div></div>
        ...
        $form->addElement(new Element_Checkbox("<b>" . __('Display user Avatar', 'registrationmagic-gold') . "</b>", "display_user_avatar", array(1 => ""), array("class" => "rm-static-field rm_input_type","ng-model"=>"displayAvatar", "value" => isset($params['display_user_avatar']) ? $params['display_user_avatar'] : 0, "longdesc" => RM_UI_Strings::get('LABEL_DISPLAY_AVATAR') )));
        $form->addElement(new Element_Checkbox("<b>" . __("Display user’s name", 'registrationmagic-gold') . "</b>", "display_user_name", array(1 => ""), array("class" => "rm-static-field rm_input_type","ng-model"=>"displayUsername", "value" => isset($params['display_user_name']) ? $params['display_user_name'] : 0, "longdesc" => RM_UI_Strings::get('LABEL_DISPLAY_USERNAME') )));
        
        $form->addElement(new Element_Checkbox("<b>" . __('Display greetings', 'registrationmagic-gold') . "</b>", "display_greetings", array(1 => ""), array("class" => "rm-static-field rm_input_type","ng-model"=>"displayGreetings", "value" => isset($params['display_greetings']) ? $params['display_greetings'] : 0, "longdesc" => RM_UI_Strings::get('LABEL_DISPLAY_GREETINGS') )));
            $form->addElement(new Element_HTML('<div id="rm_display_greetings" class="childfieldsrow">'));   
                $form->addElement(new Element_Textbox("<b>" . __('Greetings Text', 'registrationmagic-gold') . "</b>", "greetings_text", array("value" => $params['greetings_text'],"ng-model"=>"greetingText", "longDesc" => RM_UI_Strings::get('FIELD_GREETING_TEXT') )));
            $form->addElement(new Element_HTML('</div>'));
            
        $form->addElement(new Element_Checkbox("<b>" . __('Display custom message', 'registrationmagic-gold') . "</b>", "display_custom_msg", array(1 => ""), array("class" => "rm-static-field rm_input_type","ng-model"=>"displayCustomMessage", "value" => isset($params['display_custom_msg']) ? $params['display_custom_msg'] : 0, "longdesc" => RM_UI_Strings::get('LABEL_DISPLAY_CUSTOM_MSG') )));
            $form->addElement(new Element_HTML('<div id="rm_display_custom_msg" class="childfieldsrow">'));   
                $form->addElement(new Element_Textarea("<b>" . __('Custom message', 'registrationmagic-gold') . "</b>", "custom_msg", array("value" => $params['custom_msg'],"ng-model"=>"customMessage", "longDesc" => RM_UI_Strings::get('FIELD_CUSTOM_MSG') )));
            $form->addElement(new Element_HTML('</div>'));
        ...
        $form->addElement(new Element_Checkbox("<b>" . __('Display user account link', 'registrationmagic-gold') . "</b>", "display_account_link", array(1 => ""), array("class" => "rm-static-field rm_input_type","ng-model"=>"displayAccountLink", "value" => isset($params['display_account_link']) ? $params['display_account_link'] : 0, "longdesc" => RM_UI_Strings::get('HELP_ACCOUNT_TEXT') )));
            $form->addElement(new Element_HTML('<div id="rm_display_account" class="childfieldsrow">'));   
                $form->addElement(new Element_Textbox("<b>" . __('User account link text', 'registrationmagic-gold') . "</b>", "account_link_text", array("value" => $params['account_link_text'],"ng-model"=>"accountLinkText", "longDesc" => RM_UI_Strings::get('HELP_ACCOUNT_LINK') )));
            $form->addElement(new Element_HTML('</div>'));
            
        $form->addElement(new Element_Checkbox("<b>" . __('Display logout link', 'registrationmagic-gold') . "</b>", "display_logout_link", array(1 => ""), array("class" => "rm-static-field rm_input_type","ng-model"=>"displayLogoutLink", "value" => isset($params['display_logout_link']) ? $params['display_logout_link'] : 0, "longdesc" => RM_UI_Strings::get('HELP_LOGOUT_TEXT') )));
            $form->addElement(new Element_HTML('<div id="rm_display_logout" class="childfieldsrow">'));   
                $form->addElement(new Element_Textbox("<b>" . __('Logout link text', 'registrationmagic-gold') . "</b>", "logout_text", array("value" => $params['logout_text'],"ng-model"=>"logoutText", "longDesc" => RM_UI_Strings::get('HELP_LOGOUT_LINK') )));
            $form->addElement(new Element_HTML('</div>'));
