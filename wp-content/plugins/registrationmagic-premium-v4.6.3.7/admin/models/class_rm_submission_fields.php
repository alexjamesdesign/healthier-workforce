...
//    }
    ...
    private function validate_submission_id()
    {
        if (empty($this->submission_id))
        {
            $this->errors['SUBMISSION_ID'] = __("Submission id must not be empty.",'registrationmagic-gold');
        }
    }

    private function validate_field_id()
    {
        if (empty($this->field_id))
        {
            $this->errors['FIELD_ID'] = __("Field id must not be empty.",'registrationmagic-gold');
        }
    }
