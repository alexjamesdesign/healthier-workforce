...
if(!empty($rm_interval)){
   ...
   $start_date = isset($interval[0]) ? $interval[0] : '';
   $end_date = isset($interval[1]) ? $interval[1] : '';
}
/* Sort Started */
            ...
            <form id="rm_user_manager_sideform" action="<?php echo esc_url(add_query_arg('rm_reqpage', '1')); ?>" method="GET">
                ...
                <div class="tablenav top rm-tablenav-top">
                    ...
                    <div class="alignleft actions">
                        ...
                        <input type="text" name="rm_interval" id="rm_users_date" placeholder="<?php _e('All Dates','custom-registration-form-builder-with-submission-manager');?>" value="<?php echo esc_attr($rm_interval); ?>" readonly/>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            if (isset($user->roles) && !empty($user->roles)) {
                                                ...
                                                echo esc_html__('None','custom-registration-form-builder-with-submission-manager');
                                            }
                                            ?>
                                        </td>
