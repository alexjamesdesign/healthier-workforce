...
<div class="rmagic">
    ...
    <div class="operationsbar">
        ...
        <div class="nav">
            <ul>
                <li><a href="<?php echo get_admin_url() . 'user-edit.php?user_id=' . esc_attr($data->user->ID); ?>"><?php echo wp_kses_post(RM_UI_Strings::get('LABEL_EDIT')); ?></a></li>
                <?php
                if ($data->curr_user != $data->user->ID)
                {
                    ?>
                    <li onclick="jQuery.rm_do_action('form_user_page_action', 'rm_user_delete')"><a href="javascript:void(0)"><?php echo wp_kses_post(RM_UI_Strings::get('LABEL_DELETE')); ?></a></li>
                    <?php
                }
                ?>
                <?php
                if ($data->user->rm_user_status != 1)
                {
                    ...
                    {
                        ?>
                        <li onclick="jQuery.rm_do_action('form_user_page_action', 'rm_user_deactivate')"><a href="#"><?php echo wp_kses_post(RM_UI_Strings::get('DEACTIVATE')); ?></a></li>
                        <?php
                    }
                } else
                {
                    ?>
                    <li onclick="jQuery.rm_do_action('form_user_page_action', 'rm_user_activate')"><a href="#"><?php echo wp_kses_post(RM_UI_Strings::get('ACTIVATE')); ?></a></li>
                    <?php
                }
                ?>
                    <li onclick="rm_show_send_mail_popup()"><a href="#"><?php echo wp_kses_post(RM_UI_Strings::get('SEND_MAIL')); ?></a></li>
            </ul>
        </div>
        ...
        <div class="rm-user-info">
            ...
            <div class="rm-profile-fields">
                ...
                <div class="rm-profile-field-row">
                    ...
                    <div class="rm-field-label"><?php echo wp_kses_post(RM_UI_Strings::get('FIELD_TYPE_FNAME')); ?></div>
                    <div class="rm-field-value"><?php echo esc_html($data->user->first_name); ?></div>
                </div>

                <div class="rm-profile-field-row">

                    <div class="rm-field-label"><?php echo wp_kses_post(RM_UI_Strings::get('FIELD_TYPE_LNAME')); ?></div>
                    <div class="rm-field-value"><?php echo esc_html($data->user->last_name); ?></div>
                </div>

                <div class="rm-profile-field-row">

                    <div class="rm-field-label"><?php echo wp_kses_post(RM_UI_Strings::get('LABEL_EMAIL')); ?></div>
                    <div class="rm-field-value"><?php echo esc_html($data->user->user_email); ?></div>
                </div>

                <div class="rm-profile-field-row">

                    <div class="rm-field-label"><?php echo wp_kses_post(RM_UI_Strings::get('LABEL_ROLE')); ?></div>
                    <?php
                ...
                <div class="rm-profile-field-row">
                    ...
                    <div class="rm-field-label"><?php echo wp_kses_post(RM_UI_Strings::get('LABEL_BIO')); ?></div>
                    <div class="rm-field-value"><?php echo esc_html($data->user->description); ?></div>
                </div>
                <div class="rm-profile-field-row">

                    <div class="rm-field-label"><?php echo wp_kses_post(RM_UI_Strings::get('FIELD_TYPE_NICKNAME')); ?></div>
                    <div class="rm-field-value"><?php echo esc_html($data->user->nickname); ?></div>
                </div>
                 <div class="rm-profile-field-row">

                    <div class="rm-field-label"><?php echo wp_kses_post(RM_UI_Strings::get('FIELD_TYPE_WEBSITE')); ?></div>
            ...
            <div class="rm-user-content">
                <div class="rm-profile-fields" id="rmfirsttabcontent">
                    ...
                    if (is_array($data->custom_fields) || is_object($data->custom_fields))
                        ...
                        echo "<div class='rmnotice'>" . wp_kses_post(RM_UI_Strings::get('MSG_NO_CUSTOM_FIELDS')) . "</div>";
                    ?>
                ...
                <table class="user-content rmagic-table" id="rmsecondtabcontent">
                    ...
                    if (count($data->submissions) !== 0)
                    {
                        ...
                        <th>#</th> <th><?php echo wp_kses_post(RM_UI_Strings::get('LABEL_FORM')); ?></th> <th><?php echo wp_kses_post(RM_UI_Strings::get('LABEL_DATE')); ?></th> <th>&nbsp;</th> <th>&nbsp;</th>
                    ...
                    {
                        echo "<tr> <td class='rmnotice'>" . wp_kses_post(RM_UI_Strings::get('MSG_NO_SUBMISSIONS_USER')) . "</td></tr>";
                    }
                    ?>
                ...
                <table class="user-content rmagic-table" id="rmthirdtabcontent">
                    ...
                    {
                        ?>
                        <th>#</th> <th><?php echo wp_kses_post(RM_UI_Strings::get('LABEL_FORM')); ?></th> <th><?php echo wp_kses_post(RM_UI_Strings::get('LABEL_DATE')); ?></th> <th><?php echo wp_kses_post(RM_UI_Strings::get('LABEL_PAYMENT')); ?></th> <th>&nbsp;</th>
                        <?php
                        $i = 0;
                        ...
                        echo "<tr> <td class='rmnotice'>" . wp_kses_post(RM_UI_Strings::get('MSG_NO_PAYMENTS_USER')) . "</td></tr>";
                    ?>
                </table>
                ...
                <table class="user-content rmagic-table" id="rmfourthtabcontent">
                    ...
                    if (is_array($data->sent_emails) && count($data->sent_emails) !== 0) {
                        ...
                        <th><?php echo wp_kses_post(RM_UI_Strings::get('LABEL_EMAIL_SUB')); ?></th> <th><?php echo wp_kses_post(RM_UI_Strings::get('LABEL_EMAIL_BODY')); ?></th><th><?php echo wp_kses_post(RM_UI_Strings::get('LABEL_EMAIL_SENT_ON')); ?></th> <th>&nbsp;</th>
                        ...
                        foreach ($data->sent_emails as $email) {
                            ...
                            ?>
                            <tr><td><?php echo esc_html(htmlspecialchars_decode($email->sub));; ?></td><td><?php echo wp_kses_post(htmlspecialchars_decode($email->body)); ?></td><td><?php echo esc_html(RM_Utilities::localize_time($email->sent_on)); ?></td><td><a href="?page=rm_sent_emails_view&rm_sent_email_id=<?php echo esc_attr($email->mail_id); ?>"><?php echo wp_kses_post(RM_UI_Strings::get("VIEW")); ?></a></td>
                            </tr>
                            <?php
                        }
                    } else {
                        echo "<tr> <td class='rmnotice'>" . wp_kses_post(RM_UI_Strings::get('MSG_NO_SENT_EMAIL_USER')) . "</td></tr>";
                    }
                    ?>
