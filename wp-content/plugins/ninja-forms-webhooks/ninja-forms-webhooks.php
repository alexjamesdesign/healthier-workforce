...
final class NF_Webhooks
{
    ...
    {
        if (class_exists('NinjaForms\\Includes\\Abstracts\SotAction')) {
            $actions['webhooks'] = new NF_Webhooks_Actions_SotWebhooks();
        } else {
            $actions['webhooks'] = new NF_Webhooks_Actions_Webhooks(); // includes/Actions/Webhooks.php
        }
        return $actions;
    }
...
/**
 * Still required for managing the import of 2.9x exports.
 * Remove this filter when those exports are no longer supported.
 */
